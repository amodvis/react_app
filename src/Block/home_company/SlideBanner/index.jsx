...
export default class SlideBanner extends Component {
  ...
  render() {
    ...
    const publicIceDistUrl = SlideBanner.publicIceDistUrl;
    return (
      <div className="hy-friends-list">
        ...
        >
          <img
            ...
            src={publicIceDistUrl + "public/images/CdqiMTPofpGZyLcJkDHX.svg"}
          />
          <h4>南都物业</h4>
          <span>适用场景：物业缴费</span>
          <p>
          ...
          <img
            ...
            src={publicIceDistUrl + "public/images/MhShJeukuJNkenGytSiq.svg"}
          />
        </a>
        ...
        >
          <img
            alt=""
            className="hy-friends-img"
            src={publicIceDistUrl + "public/images/ZWoRmVSYImddLaRYyQog.jpg"}
          />
          <h4>金地物业</h4>
          ...
          <img
            alt=""
            className="hy-friends-qr"
            src={publicIceDistUrl + "public/images/cONkAwDeKdlzkcgchJLT.png"}
          />
        </a>
        ...
        >
          <img
            alt=""
            className="hy-friends-img"
            src={publicIceDistUrl + "public/images/MHiDpDgUNShsjTCQXKKd.jpg"}
          />
          <h4>宋都阳光</h4>
          <span>适用场景：智能门禁</span>
          <p>
        ...
        >
          <img
            alt=""
            className="hy-friends-img"
            src={publicIceDistUrl + "public/images/JQBQcVBtAiyTGINHQNzh.jpg"}
          />
          <h4>融侨物业</h4>
